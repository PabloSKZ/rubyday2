...
#puts how_many(journalists)

#puts how_many_with_number(journalists)

#puts how_many_aude(journalists)

#puts how_many_capital_begin(journalists)

#puts how_many_with_capital(journalists)

#puts how_many_underscore(journalists)
...
puts "=== Menu ==="
puts "1. Combien de journalistes en activités ?"
